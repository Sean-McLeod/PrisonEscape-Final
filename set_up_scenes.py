...
class SetUpScenes:
    ...
    def set_up_game_scene_one(self):
        ...
        dragon = pygame.transform.flip(pygame.transform.scale(pygame.image.load("Sprites/dragons/dragon1.png"), (constants.DRAGON_WIDTH, constants.DRAGON_HEIGHT)), True, False)
    ...
    def set_up_game_scene_two(self):
        ...
        door = pygame.transform.scale(pygame.image.load(constants.CASTLE_DOOR_IMAGE), (85, 120))
